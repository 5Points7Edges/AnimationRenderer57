 ...
 * v0.3.0
 * svg Renderer
 * Project restructured: Changed to Manim Algorithms
 * This renderer can render a svg file,
 * Almost robust: concave or convex, with holes, back and front side rendered
 * FPS (ChuShiBiao.svg): ca. 200 fps
